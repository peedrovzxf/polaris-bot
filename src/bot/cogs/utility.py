...
class UtilityCog(commands.Cog):
    ...
    async def get_server_info(self, interaction: discord.Interaction):
        await interaction.response.send_message(
            "Getting server info...", ephemeral=True
        )
        ...
        embed = discord.Embed(
            title="Server Information", color=discord.Color.from_rgb(0, 0, 0)
        )
        ...
        embed.add_field(
            name="Member Count", value=server_info.member_count, inline=True
        )
        embed.add_field(name="Bot Count", value=server_info.bot_count, inline=True)

        embed.add_field(
            name="Roles",
            value=", ".join(server_info.roles) + f" ({len(server_info.roles)})",
            inline=False,
        )
        ...
        embed.set_thumbnail(
            url="https://cdn.discordapp.com/attachments/1343460842318073896/1481716543644766291/server-info-thumbnail.jpg?ex=69b45390&is=69b30210&hm=c3b7477fbf2284cbe131840b616a5f6ff0322f6cf703a06c158bd84f1f61e8f1&"
        )
